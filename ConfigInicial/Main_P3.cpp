...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Proyecciones y transformaciones basicas - Jacinto Robledo Valeria Berenice", nullptr, nullptr);
