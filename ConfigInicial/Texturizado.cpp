...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Jacinto Robledo - Texturizado", nullptr, nullptr);
	...
	GLfloat vertices[] =
	{
		...
		0.5f, -0.5f, 0.0f,	   1.0f, 1.0f,1.0f,		1.0f,0.0f, //defino donde comienzan y como terminan
