...
float movY=0.0f;
float movZ=-5.0f;
float rot = 0.0f; //nos permite manimpular la vista
int main() {
	glfwInit();
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Jacinto Robledo - Modelado geometrico", nullptr, nullptr);
 ...
 void Inputs(GLFWwindow* window) { //función que maneja la entrada del teclado para mover la cámara
